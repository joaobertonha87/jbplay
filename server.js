...
app.get("/health", (_req, res) => res.json({ ok: true, app: "JB Play Aula na Mão V50.0", ai: !!client, aulaNaMaoImport: true, autoExpandBlocks: true, singleFundamental: true, staticTacticalBoards: true, clearArrowRouting: true, premiumCourtLayout: true, premiumDashboard: true, fullScreenSafeArea: true, whiteSandCourt: true, barefootPlayers: true, brandedA4Export: true, multiPagePdf: true, highResolutionJpg: true, personalizedHero: true, completeJpgExport: true, fullCourtFit: true, liveLessonMode: true, liveTimers: true, trackerLessonBridge: true, manualTacticalEditor: true, touchTacticalEditing: true, tacticalUndoRedo: true, manualLayoutsInExports: true, errorContextTracking: true, contextualReports: true, trackerToDrillsPrescription: true, deviceModes: true }));
...
app.listen(port, "0.0.0.0", () => console.log(`JB Play Aula na Mão V50.0 em http://0.0.0.0:${port}`));
