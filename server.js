...
app.get("/health", (_req, res) => res.json({ ok: true, app: "JB Play Aula na Mão V34.0", ai: !!client, aulaNaMaoImport: true }));
...
app.listen(port, "0.0.0.0", () => console.log(`JB Play Aula na Mão V34.0 em http://0.0.0.0:${port}`));
